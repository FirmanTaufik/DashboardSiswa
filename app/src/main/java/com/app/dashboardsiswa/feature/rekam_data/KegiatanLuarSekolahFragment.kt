...
import com.app.dashboardsiswa.databinding.DialogAddKegiatanLuarBinding
...
class KegiatanLuarSekolahFragment : Fragment() {
    ...
    private fun dialogAdd() {
        val dialog = DialogAddKegiatanLuarBinding.inflate(layoutInflater)
        val itemsKegiatan = listOf( "Pengembangan Kerohanian" , "Kegiatan Kemasyarakatan")
        dialog.autoJenisKegiatan.setAdapter(ArrayAdapter(requireContext(), R.layout.dropdown_item, itemsKegiatan))
        ...
        dialog.editMulaiTanggal.setOnClickListener {
            Utils.showDateDialog(requireContext(), dialog.editMulaiTanggal)
        }
        dialog.editSelesaiTanggal.setOnClickListener {
            Utils.showDateDialog(requireContext(), dialog.editSelesaiTanggal)
        }
