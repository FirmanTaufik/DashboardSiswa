...
class PrestasiFragment : Fragment() {
    ...
    private fun dialogAdd() {
        val dialog = DialogAddPrestasiBinding.inflate(layoutInflater)

        val itemsKegiatan = listOf( "Olahraga","Seni","Matematika","Sains","IPS", "Bahasa"
            , "Teknologi Informasi", "Paskibra/Pramuka/PMR", "Lain-lain")
        dialog.autoBidang.setAdapter(ArrayAdapter(requireContext(), R.layout.dropdown_item, itemsKegiatan))
