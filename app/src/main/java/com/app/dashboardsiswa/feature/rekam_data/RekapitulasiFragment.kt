 ...
 * Use the [RekapitulasiFragment.newInstance] factory method to
...
class RekapitulasiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Utils.showToastInfo(requireContext(), "rekappp")
    ...
    companion object {
         ...
         * @return A new instance of fragment RekapitulasiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RekapitulasiFragment().apply {
